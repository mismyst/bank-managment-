...
public class LoginPage extends javax.swing.JFrame {
    ...
    private void jButtonLoginActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonLoginActionPerformed
        try
        {
            Connection con=DriverManager.getConnection("jdbc:mysql://localhost:3306/Bank2?autoReconnect=true","root","Nayantra1234@");
            ...
            if(flag == 1)
            {
                ...
                try
                {
                    Connection mycon=DriverManager.getConnection("jdbc:mysql://localhost:3306/Bank2?autoReconnect=true","root","Nayantra1234@");
                    String s1="";
